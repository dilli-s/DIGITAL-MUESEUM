...
const AdminExhibitions = () => {
  ...
  const handleDelete = async () => {
    try {
      ...
      console.log(err.response?.data?.error?.message || 'Failed to delete exhibition.');
      setDeleteConfirm(null);
    }
  };
  ...
  return (
    <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      ...
      <GenericCsvImporter
        ...
        existingItems={exhibitions}
        createItem={createAdminExhibition}
        updateItem={updateAdminExhibition}
